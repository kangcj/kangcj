...
training_data_file = open("C:/Users/VISSanKCJ/Desktop/wine_data.csv")
...
for i in range(10000):
    ...
    for record in training_data_list:
        ...
        inputs = (np.asfarray(all_values[1:]) / 1547.0 * 0.99) + 0.01
...
test_data_file = open("C:/Users/VISSanKCJ/Desktop/wine_test.csv")
